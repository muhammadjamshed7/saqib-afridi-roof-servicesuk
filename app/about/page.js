                ...
                <div className="col-xl-6 col-lg-6">
                  ...
                  >
                    <div className="about-one__img">
                      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSN1gp0HWHlaFaydmLiRSTlurAcq29JaFUy3A&s" />
                        ...
                        >
                          <div className="about-one__tab-content-box">
                            <p className="about-one__text-1">
                              Construction is an essential industry that
                              involves building and designing structures such as
                      ...
                      <ul className="counter-two__points-list list-unstyled">
                        <li>
                          ...
                          <div className="content">
                            ...
                            <p>
                              Our roofing services include installation,
                              maintenance, and repair for residential and
                        ...
                        <li>
                          ...
                          <div className="content">
                            ...
                            <p>
                              We provide top-notch roofing solutions tailored to
                              meet your specific needs and ensure durability.
                            </p>
                          </div>
                        </li>
                        <li>
                          ...
                          <div className="content">
                            ...
                            <p>
                              ...
                              high-quality roofing services with a focus on
                  ...
                  >
                    <div className="counter-two__right">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(/assets/images/shapes/counter-two-right-bg-shape.png)",
                        }}
                      ></div>
                      <div className="row">
                        ...
                        <div className="we-serve__right">
                          <div className="we-serve__content-box">
                            <div className="we-serve__content-left">
                              <span className="we-serve__content-tagline">
                                About Us
                              </span>
                            ...
                            <div className="we-serve__content-right">
                              <div className="we-serve__content-count-box">
                                ...
                                <p className="we-serve__count-text">
                                  Clients Reviews
                                </p>
                              </div>
                    ...
                    <ul className="services-three__service-list list-unstyled">
                        <li className="hover-item">
                            <div className="services-three__service-list-single">
                                ...
                                <h3 className="services-three__title">
                                    <Link href="/pitched-roof">Elevation Elite Roof</Link>
                                </h3>
                            </div>
                            <div className="hover-item__box">
                                <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScBMaP5fLGBjNJbBnqp5dumkj2UvtS-yxmTrYNaien5GfOhEzAgnWlI-UyogwOkwDETkY&usqp=CAU"
                                    alt="Image"
                        ...
                        <li className="hover-item">
                            <div className="services-three__service-list-single">
                                ...
                                <h3 className="services-three__title">
                                    <Link href="/flat-roof">Apex Flat Roof Installation</Link>
                                </h3>
                            </div>
                            <div className="hover-item__box">
                                <img
                                    src="https://budgetroofingsolutions.co.uk/wp-content/uploads/2023/07/Budget-Roofing-Solutions-New-Roof-Installation-banner.jpg"
                                    alt="Image"
                                    className="hover-item__box-img"
                                />
                            </div>
                        ...
                        <li className="hover-item">
                            <div className="services-three__service-list-single">
                                ...
                                <h3 className="services-three__title">
                                    <Link href="/roof-repair">Pinnacle Roof Repair</Link>
                                </h3>
                            </div>
                            <div className="hover-item__box">
                                <img
                                    src="https://excel-reno.com/wp-content/uploads/2023/04/Rectangle-5462.jpg"
                                    alt="Image"
                                    className="hover-item__box-img"
                                />
                            </div>
                        ...
                        <li className="hover-item">
                            <div className="services-three__service-list-single">
                                ...
                                <h3 className="services-three__title">
                                    <Link href="/gutter-fascia">Precision Gutter Fascia</Link>
                                </h3>
                            </div>
                            <div className="hover-item__box">
                                <img
                                    src="https://www.anglianhome.co.uk/-/media/ahi/personalisation-images/rooftrim/rooftrim-explanation.png?mh=727"
                                    alt="Image"
                                    className="hover-item__box-img"
                                />
                            </div>
                        ...
                        <li className="hover-item">
                            <div className="services-three__service-list-single">
                                ...
                                <div className="services-three__sub-title">
                                    <p>Chimney Installation</p>
                                </div>
                                <h3 className="services-three__title">
                                    <Link href="/chimney-installation">Summit Chimney Services</Link>
                                </h3>
                            </div>
                            <div className="hover-item__box">
                                <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvB8fDrBg8m22hhURhsMigw89ZAqa3R0lj9Q&s"
                                    alt="Image"
                                    className="hover-item__box-img"
                                />
                            </div>
                        ...
                        <li className="hover-item">
                            <div className="services-three__service-list-single">
                                ...
                                <h3 className="services-three__title">
                                    <Link href="/roof-cleaning">Shine Roof Cleaning</Link>
                                </h3>
                            </div>
                            <div className="hover-item__box">
                                <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRe7Gd-QoyxM4EFDRvhzvkxY5DahyW_GuK98A&s"
                                    alt="Image"
                                    className="hover-item__box-img"
                                />
                            </div>
                                ...
                                <div className="testimonial-one__slider">
                                    <div className="testimonial-one__single">
                                        ...
                                        <p className="testimonial-one__text">
                                            "The roofing service was exceptional. The team was professional and efficient."
                                        </p>
                                        <h3 className="testimonial-one__name">John Doe</h3>
                                    </div>
                                    <div className="testimonial-one__single">
                                        <div className="testimonial-one__image">
                                        ...
                                        <p className="testimonial-one__text">
                                            "Highly recommend their services. My roof looks amazing!"
                                        </p>
                                        <h3 className="testimonial-one__name">Jane Smith</h3>
                                    </div>
                                    <div className="testimonial-one__single">
                                        <div className="testimonial-one__image">
                                        ...
                                        <p className="testimonial-one__text">
                                            "Great experience from start to finish. The quality is top-notch."
                                        </p>
                                        <h3 className="testimonial-one__name">Michael Brown</h3>
                                    </div>
                                    <div className="testimonial-one__single">
                                        <div className="testimonial-one__image">
                                            <img src="https://randomuser.me/api/portraits/women/29.jpg" alt="Client" />
                                        </div>
                                        <p className="testimonial-one__text">
                                            "The team was friendly and completed the work on time. Very satisfied!"
                                        </p>
                                        <h3 className="testimonial-one__name">Emily Davis</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
