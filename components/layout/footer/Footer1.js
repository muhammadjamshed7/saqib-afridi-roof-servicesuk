      ...
      <div className="site-footer__top">
        <div className="container">
          <div className="site-footer__top-inner">
            <Link href="#" className="site-footer__top-content">
                ...
                <div className="footer-widget__column footer-widget__services">
                  ...
                  <ul className="footer-widget__services-list list-unstyled">
                    ...
                    <li>
                      ...
                      <Link href="#">
                        <span className="icon-angle-left"></span>Guttering, Fascia and soffits{" "}
                      </Link>
                    </li>
                    <li>
                      <Link href="/top-notch-roofing-restoration"><span className="icon-angle-left"></span>Top Notch Roof</Link>
                      <Link href="#">
                        <span className="icon-angle-left"></span>Roof moss & Gutter cleaning
                      </Link>
                    </li>
                    <li>
                      <Link href="/top-notch-roofing-restoration"><span className="icon-angle-left"></span>Top Notch Roof</Link>
                      <Link href="#">
                        <span className="icon-angle-left"></span>Dry ridges system
                      </Link>
                    </li>
                  </ul>
                </div>
                  ...
                  <div className="footer-widget__contact-inner">
                    <ul className="footer-widget__contact-list list-unstyled">
                      <li>
                        ...
                        <div className="text">
                          <p>
                            <a href="mailto:Saqibshahkaswal@gmail.com">
                              Saqibshahkaswal@gmail.com
                            </a>
                          </p>
                        </div>
                      </li>
                      <li>
                        ...
                        <div className="text">
                          <p>
                            Street name: Wentworth Avenue <br />
                            City: Slough
                            <br /> Postcode: SL2 2DR
                          </p>
                        </div>
                      ...
                      <li>
                        ...
                        <div className="text">
                          <p>
                            <a href="tel:+447832766458">+447832766458</a>,{" "}
                            <a href="tel:"></a>
                          </p>
                        </div>
                      </li>
              ...
              >
                <div className="footer-widget__column footer-widget__newsletter">
                  ...
                  <p className="footer-widget__newsletter-text">
                    It is a long established fact that and Empowering
                    Communities
                  </p>
                  <form
        ...
        <div className="container">
          <div className="site-footer__bottom-inner">
            <p className="site-footer__bottom-text">
              © SmartWeb Labs Tech| All Rights Reserved
            </p>
